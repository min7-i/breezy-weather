...
class SettingsActivity : GeoActivity() {
    ...
    @Inject lateinit var statementManager: StatementManager
                ...
                WidgetsSettingsScreen(
                    ...
                    postNotificationPermissionEnsurer = { succeedCallback ->
                        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU &&
                            ...
                            postNotificationPermission(succeedCallback)
                        }
                    },
                    updateWidgetIfNecessary = { context: Context ->
                        scope.launch {
    ...
    private fun postNotificationPermission(
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU &&
            ...
            PermissionHelper.requestPermissionWithFallback(
                ...
                statementManager = StatementManager(this),
                requestPermissionFallback = { IntentHelper.startNotificationSettingsActivity(this) },
            )
        } else {
            succeedCallback()
        }
